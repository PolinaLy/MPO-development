...
class TrainingLegsMain extends StatefulWidget {
  @override
  TrainingLegs createState()=> TrainingLegs();
}

class TrainingLegs extends State {
  var _counter = 6;
  late Timer _timer;
              ...
              child: Column (
                children: [
                  ...
                  StreamBuilder<QuerySnapshot>(
                      stream: FirebaseFirestore.instance.collection('TrainingLegs').snapshots(),
